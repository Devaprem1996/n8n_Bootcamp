...
// Get credentials from environment (in Vercel/Netlify, set in dashboard)
const SUPABASE_URL = import.meta.env.VITE_SUPABASE_URL || window.ENV_SUPABASE_URL
const SUPABASE_ANON_KEY = import.meta.env.VITE_SUPABASE_ANON_KEY || window.ENV_SUPABASE_ANON_KEY
